...
from automation.config.config_loader import ConfigLoader
...
class ProjectConfig:
    ...
    def initialize(cls):
        ...
        cls._load_build_config_json(build_config_path)

        cls._initialized = True

    @classmethod
    def _load_build_config_json(cls, build_config_path):
        """
        Load build configuration from a JSON file.
        """
        config_data = ConfigLoader(build_config_path)
